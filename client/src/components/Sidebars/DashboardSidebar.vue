<template>
  ...
  >
    <div class="brand">
      <div class="brand-pic">
        <img :src="`http://128.199.187.173:3000/logo/logo.png`" alt="" />
      </div>
    ...
    <a-menu theme="light" mode="inline" style="text-decoration: none">
      ...
      <a-sub-menu id="phi">
        <span slot="title" class="submenu-title-wrapper">
          <span class="icon">
            <b-icon icon="gear-fill" style="color: blue; font-size: 24px">
            </b-icon>
          </span>
          <span
            class="label menutext"
...
export default {
  ...
  methods: {
    async getweb() {
      const response = await axios.get(`http://128.199.187.173:3000/website/img`);
