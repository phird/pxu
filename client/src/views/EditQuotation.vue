...
export default {
  ...
  methods: {
    ...
    submitquo() {
      ...
      axios
        .post(`http://128.199.187.173:5000/quotation/${this.qID}`, {
    ...
    async submit() {
      if (this.changein) {
        await axios.delete(`http://128.199.187.173:5000/scope/${this.qID}`);
        await axios.delete(`http://128.199.187.173:5000/invoice/${this.qID}`);
        const requestone = [];
        ...
        for (let i = 1; i <= this.sumtodo.qIN; i++) {
          ...
          requestone[i - 1] = axios.post("http://128.199.187.173:5000/invoice", {
            inID: this.inID,
            qID: this.qID,
        ...
        for (let i = 0; i < this.todos.length; i++) {
          requesttwo[i] = axios.post("http://128.199.187.173:5000/scope", {
            qID: this.qID,
    ...
    async getid(id) {
      try {
        const response = await axios.get(
          `http://128.199.187.173:5000/quotation/${id}`
        );
    ...
    async getscope(id) {
      try {
        const response = await axios.get(`http://128.199.187.173:5000/scope/${id}`);
